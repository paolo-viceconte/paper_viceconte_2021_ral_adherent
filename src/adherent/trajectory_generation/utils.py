...
def define_initial_nn_X(robot: str) -> List:
    ...
    if robot == "iCubV2_5":
        ...
        initial_nn_X = [[# Ground base positions (24)
                         0.0003238157762338452 ,-0.004413043722569798 ,-0.00031320907828550715 ,-0.005832858302699996 ,
                         0.00022607008129867397 , -0.00437750612986255 ,1.3673707262629704e-05 ,-0.0024185750713530967 ,
                         5.825248398459098e-05 ,-0.0011522623258508418 , 0.0 ,0.0,
                         0.00012124339515246635, 0.0006522543471820551, -0.0003241636296503099, 0.0009994263390877803,
                         -0.000546872517591529, 0.0008784458075399852, -0.00011401195916144885, -2.9032753639708077e-06,
                         0.0016350063063580583, -0.0008544945005340319, 0.00492427064537744, -0.0016550295509318227,
                         # Ground facing directions (24)
                         0.9999872302893787, -0.0050536381129905935, 0.9998541586568077, 0.017078097572249987,
                         0.9999644926316414, 0.008426949385391753, 0.9999975155924419, -0.0022290825341202704,
                         0.9999993679109715, -0.0011243565525508336, 1.0, -8.337091592043447e-17,
                         1.0001645463453193, -0.0035832638865569036, 1.0007565165388588, -0.0054299371399287285,
                         1.0009815397732986, -0.004337475359839556, 1.000759240970355, -0.0032169063414065977,
                         0.9998158752461932, -0.00314406254242676, 0.9968427211759179, -0.0018774065851480273,
                         # Ground base velocities (24)
                         0.0, 0.0, 0.003009681604036402, 0.012037467700863898,
                         -0.0011528371887823672, 0.003397448383120476, 0.00016410796155694258, 0.004932504189156851,
                         -0.00013445619490958712, 0.004687680433400875, 0.0, 0.0,
                         0.001659897094698, 0.004375766013562967, -0.007502117324476733, 0.0006435344901271167,
                         0.001292381738813568, 0.0001584358051694124, 0.008280616099259112, -0.002728322194598082,
                         0.017772261490587714, -0.00599032118801847, 0.02164974855289188, 0.005557374168295234,
                         # Future ground trajectory length (1)
                         0.14344739779350893,
                         # Joint positions (32)
                         -0.11836770776739093, 0.0494024519184956, 0.0707070536427681, -0.07712536154379374,
                         -0.09273822384708587, -0.051916011249563535, -0.11860960796471309, 0.05610996133941092,
                         0.07374101029147806, -0.08284797905748773, -0.09922915795376905, -0.05484532257220818,
                         0.0008602868797261008, 0.33817072384436686, 0.003304074940211274, -0.2715637151402699,
                         0.20549159940333056, -0.35186764801956955, -0.03727671256889198, 0.20195043246855116,
                         -0.31016894855426574, 0.1634218676791499, 0.1827664149915692, 0.0010520152543355005,
                         -0.012849798228642231, -0.2715264968112397, 0.2093867152753933, -0.34922637349237845,
                         -0.03187390215122049, 0.20365097474621702, -0.3101689507052845, 0.0006845710449852049,
                         # Joint velocities (32)
                         -0.052180630565671494, -0.014610234658722984, 0.018161554395605604, 0.053948193439337495,
                         0.0018437564464721832, 0.009881323307519497, -0.01864781458688038, 0.012505371575477873,
                         -0.018057872051821935, 0.004140352327255118, -0.010961599843152658, -0.008454543088125571,
                         0.0053272790948277965, -0.03349711797086042, 0.005913219034081715, 0.039240592317094626,
                         -0.00019592527531204078, -0.0046570540826978086, -0.007385929641676619, 0.04526747934242537,
                         0.00010611912241536476, -5.3688165848304225e-05, -0.00943715032976577, -0.005859183626552358,
                         0.03340950048695316, 0.04484522247375777, 0.00038125383236695744, -0.010601328672419207,
                         -0.03646049472667844, 0.033373806340831334, 0.00010611911617567095, 0.0006813267827965319]]
...
def define_base_pitch_offset(robot: str) -> List:
    ...
    if robot == "iCubV2_5":
        ...
        raise Exception("Base pitch offset only defined for iCubV2_5 and iCubV3.")
